          ...
          <div className="flex flex-col md:flex-row w-full m-auto items-center justify-between px-10 md:px-32 pt-24">
            ...
            <div className="flex flex-nowrap items-center gap-4">
              <a
                ...
                className={`px-8 flex gap-2 py-4 text-lg font-medium text-center text-white ${
                  showForm ? "" : "bg-customYellow"
                } rounded-md `}
              >
                <svg
      ...
      <div className="w-full max-w-2xl p-2 mx-auto rounded-2xl">
        ...
        <form id="contacto" onSubmit={handleSubmit}>
          <div className="mb-5">
            <label
              htmlFor="name"
              className="block text-gray-700 text-lg font-bold mb-2 dark:text-gray-300"
            >
              {contact.name}
            </label>
            <input
          ...
          <button
            disabled={loading}
            type="submit"
            className={`px-8 text-lg py-3 text-white bg-customYellow rounded-md w-full ${
              loading ? "bg-gray-400" : ""
            }`}
          >
